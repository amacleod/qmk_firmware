...
[_DVORAK] = LAYOUT_planck_grid(
  ...
  KC_ESC,  HL_GUI_A, HO_ALT_O, HL_CTL_E, HL_SFT_U,   KC_I,  KC_D, HR_SFT_H, HR_CTL_T, HO_ALT_N, HR_GUI_S,  KC_MINS,
...
[_COLEMAK] = LAYOUT_planck_grid(
  ...
  KC_TRNS, HL_GUI_A, HO_ALT_R, HL_CTL_S, HL_SFT_T, KC_D, KC_H, HR_SFT_N, HR_CTL_E, HO_ALT_I, HR_GUI_O, KC_QUOT,
  KC_TRNS, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_K, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_TRNS,
  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
),
[_QWERTY] = LAYOUT_planck_grid(
  KC_TRNS, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_TRNS,
  KC_TRNS, HL_GUI_A, HO_ALT_S, HL_CTL_D, HL_SFT_F, KC_G, KC_H, HR_SFT_J, HR_CTL_K, HO_ALT_L, HR_GSCLN, KC_QUOT,
